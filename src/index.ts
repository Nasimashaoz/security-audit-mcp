...
export const server = new McpServer({
  ...
  version: "1.0.0",
  description: "AI-powered security audit tools for comprehensive compliance frameworks",
});
...
server.tool(
  "cve_lookup",
  "Lookup details for a Common Vulnerabilities and Exposures (CVE) ID from MITRE",
  {
...
// Start Server conditionally to allow testing
