...
export const FRAMEWORKS: Record<string, Framework> = {
  ...
  pcidss: {
    ...
    items: [
      { id: "Req-1", title: "Network Security Controls", description: "Are network security controls installed and maintained?", risk: "CRITICAL" },
      ...
      { id: "Req-4", title: "Cryptography in Transit", description: "Is cardholder data encrypted during transmission over open, public networks?", risk: "CRITICAL" },
      ...
      { id: "Req-6", title: "Secure Software", description: "Are secure systems and software developed and maintained?", risk: "HIGH" },
      ...
      { id: "Req-8", title: "Identify Users", description: "Are users identified and authenticated to system components?", risk: "CRITICAL" },
      { id: "Req-9", title: "Physical Access", description: "Is physical access to cardholder data restricted?", risk: "MEDIUM" },
      { id: "Req-10", title: "Log and Monitor", description: "Is all access to network resources and cardholder data logged and monitored?", risk: "HIGH" },
      { id: "Req-11", title: "Test Security Systems", description: "Are security systems and processes tested regularly?", risk: "HIGH" },
  ...
  soc2: {
    name: "SOC 2 Type II",
    version: "2017",
    description: "Trust Services Criteria including Security, Availability, Processing Integrity, Confidentiality, and Privacy.",
    items: [
      ...
      { id: "CC2", title: "Communication and Information", description: "Does the organization internally and externally communicate information to support the functioning of internal control?", risk: "MEDIUM" },
      ...
      { id: "CC6", title: "Logical and Physical Access", description: "Does the organization implement logical and physical access controls to prevent unauthorized access?", risk: "CRITICAL" },
      { id: "CC7", title: "System Operations", description: "Does the organization manage system operations to detect and mitigate processing deviations?", risk: "HIGH" },
      { id: "CC8", title: "Change Management", description: "Does the organization authorize, design, develop or acquire, configure, document, test, approve, and implement changes?", risk: "MEDIUM" },
      { id: "CC9", title: "Risk Mitigation", description: "Does the organization mitigate risks to acceptable levels?", risk: "HIGH" },
    ],
  },
  hipaa: {
    ...
    items: [
      ...
      { id: "164.308(a)(3)", title: "Workforce Security", description: "Are policies and procedures implemented to ensure appropriate access to ePHI by workforce members?", risk: "HIGH" },
      { id: "164.308(a)(4)", title: "Information Access Management", description: "Are policies and procedures implemented to authorize access to ePHI?", risk: "HIGH" },
      ...
      { id: "164.310(b)", title: "Workstation Use", description: "Are policies and procedures implemented that specify the proper functions to be performed, the manner in which those functions are to be performed, and the physical attributes of the surroundings of a specific workstation or class of workstation?", risk: "MEDIUM" },
      ...
      { id: "164.310(d)(1)", title: "Device and Media Controls", description: "Are policies and procedures implemented that govern the receipt and removal of hardware and electronic media?", risk: "MEDIUM" },
      { id: "164.312(a)(1)", title: "Access Control", description: "Are technical policies and procedures implemented for electronic information systems to allow access only to those persons or software programs that have been granted access rights?", risk: "CRITICAL" },
  ...
  cisv8: {
    ...
    items: [
      ...
      { id: "CIS-2", title: "Inventory and Control of Software Assets", description: "Actively manage (inventory, track, and correct) all software.", risk: "HIGH" },
      ...
      { id: "CIS-10", title: "Malware Defenses", description: "Prevent or control the installation, spread, and execution of malicious applications.", risk: "HIGH" },
    ],
  },
  gdpr: {
    name: "GDPR",
    ...
    items: [
      ...
      { id: "Art-7", title: "Conditions for consent", description: "If processing is based on consent, is the organization able to demonstrate that the data subject has consented?", risk: "HIGH" },
      { id: "Art-15", title: "Right of access by the data subject", description: "Can data subjects access their personal data?", risk: "MEDIUM" },
      { id: "Art-17", title: "Right to erasure ('right to be forgotten')", description: "Can data subjects have their personal data erased?", risk: "MEDIUM" },
      ...
      { id: "Art-33", title: "Notification of a personal data breach to the supervisory authority", description: "Is there a process to notify the supervisory authority of a personal data breach without undue delay?", risk: "HIGH" },
      { id: "Art-34", title: "Communication of a personal data breach to the data subject", description: "Is there a process to communicate a personal data breach to the data subject without undue delay?", risk: "HIGH" },
