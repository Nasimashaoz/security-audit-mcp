...
export const FRAMEWORKS: Record<string, Framework> = {
  ...
  pcidss: {
    ...
    items: [
      { id: "Req-1", title: "Install and Maintain Network Security Controls", description: "Are network security controls configured and maintained to protect cardholder data environments?", risk: "CRITICAL" },
      { id: "Req-3", title: "Protect Stored Account Data", description: "Is stored cardholder data encrypted? Are primary account numbers masked when displayed?", risk: "CRITICAL" },
      { id: "Req-4", title: "Protect Account Data in Transit", description: "Is account data encrypted during transmission over open, public networks?", risk: "HIGH" },
      { id: "Req-8", title: "Identify Users and Authenticate Access", description: "Is access to system components uniquely identifiable to individual users? Is MFA implemented?", risk: "HIGH" },
      { id: "Req-11", title: "Test Security of Systems and Networks", description: "Are internal and external vulnerability scans performed at least quarterly? Is penetration testing conducted?", risk: "HIGH" },
    ],
  },
  soc2: {
    name: "SOC 2",
    ...
    items: [
      { id: "CC1.2", title: "Board of Directors Demonstrates Independence", description: "Does the board of directors demonstrate independence from management and exercise oversight of the development and performance of internal control?", risk: "MEDIUM" },
      { id: "CC6.1", title: "Logical Access Security", description: "Are logical access security measures implemented to restrict access to systems and data to authorized users?", risk: "CRITICAL" },
      { id: "CC6.6", title: "External Threats Protection", description: "Are boundaries established and systems protected against external threats? (e.g. firewalls, intrusion detection)", risk: "HIGH" },
      { id: "CC7.1", title: "System Configuration and Vulnerability Management", description: "Are systems configured securely? Are vulnerabilities identified and remediated in a timely manner?", risk: "HIGH" },
      { id: "CC8.1", title: "Change Management Process", description: "Is there a defined and documented change management process for system and application changes?", risk: "HIGH" },
    ],
  },
  hipaa: {
    ...
    items: [
      { id: "164.308(a)(1)", title: "Security Management Process", description: "Is there a formal risk analysis and risk management process in place to protect ePHI?", risk: "CRITICAL" },
      { id: "164.308(a)(4)", title: "Information Access Management", description: "Are policies and procedures implemented for authorizing access to ePHI based on role and need-to-know?", risk: "HIGH" },
  ...
  cis: {
    name: "CIS Controls",
    version: "v8",
    description: "Center for Internet Security Critical Security Controls, a prioritized set of actions to protect organizations and data from cyber threats.",
    items: [
      { id: "CIS-1", title: "Inventory and Control of Enterprise Assets", description: "Is there an accurate and up-to-date inventory of all enterprise assets with the potential to store or process data?", risk: "HIGH" },
      ...
      { id: "CIS-4", title: "Secure Configuration of Enterprise Assets and Software", description: "Are secure configurations established and maintained for enterprise assets (end-user devices, network devices, IoT devices, and servers) and software (operating systems and applications)?", risk: "HIGH" },
      { id: "CIS-5", title: "Account Management", description: "Are processes and tools used to assign and manage authorization to credentials for user accounts, including administrator accounts, as well as service accounts, to enterprise assets and software?", risk: "CRITICAL" },
      { id: "CIS-7", title: "Continuous Vulnerability Management", description: "Is there a continuous plan to assess and track vulnerabilities on all enterprise assets within the infrastructure?", risk: "HIGH" },
    ],
  },
  gdpr: {
    name: "GDPR",
    ...
    items: [
      ...
      { id: "Art-32", title: "Security of processing", description: "Are appropriate technical and organisational measures implemented to ensure a level of security appropriate to the risk, including encryption and pseudonymisation where appropriate?", risk: "HIGH" },
      { id: "Art-33", title: "Notification of a personal data breach to the supervisory authority", description: "Is there a process in place to notify the supervisory authority without undue delay and, where feasible, not later than 72 hours after having become aware of it, of a personal data breach?", risk: "HIGH" },
      { id: "Art-35", title: "Data protection impact assessment", description: "Is a data protection impact assessment carried out where a type of processing in particular using new technologies, and taking into account the nature, scope, context and purposes of the processing, is likely to result in a high risk to the rights and freedoms of natural persons?", risk: "MEDIUM" },
    ],
  },
};
