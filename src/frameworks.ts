...
export const FRAMEWORKS: Record<string, Framework> = {
  ...
  pcidss: {
    ...
    items: [
      { id: "Req-1", title: "Install and Maintain Network Security Controls", description: "Are network security controls configured and maintained?", risk: "HIGH" },
      { id: "Req-2", title: "Apply Secure Configurations to All System Components", description: "Are secure configurations applied to all system components?", risk: "HIGH" },
      { id: "Req-3", title: "Protect Stored Account Data", description: "Is stored account data protected?", risk: "CRITICAL" },
      { id: "Req-4", title: "Protect Cryptographic Keys", description: "Are cryptographic keys used to protect account data secured?", risk: "CRITICAL" },
      { id: "Req-5", title: "Protect All Systems and Networks from Malicious Software", description: "Are anti-malware solutions deployed and active?", risk: "HIGH" },
      { id: "Req-6", title: "Develop and Maintain Secure Systems and Software", description: "Are systems developed securely and vulnerabilities managed?", risk: "HIGH" },
      { id: "Req-7", title: "Restrict Access to System Components and Cardholder Data by Business Need to Know", description: "Is access restricted to a need-to-know basis?", risk: "CRITICAL" },
      { id: "Req-8", title: "Identify Users and Authenticate Access to System Components", description: "Are users uniquely identified and authenticated?", risk: "CRITICAL" },
      ...
      { id: "Req-10", title: "Log and Monitor All Access to System Components and Cardholder Data", description: "Is all access logged and monitored?", risk: "HIGH" },
      { id: "Req-11", title: "Test Security of Systems and Networks Regularly", description: "Are regular security tests performed?", risk: "HIGH" },
      { id: "Req-12", title: "Support Information Security with Organizational Policies and Programs", description: "Are security policies established and maintained?", risk: "MEDIUM" },
    ],
  },
  soc2: {
    name: "SOC 2",
    version: "2017 Trust Services Criteria",
    description: "System and Organization Controls 2, an auditing procedure that ensures service providers securely manage data.",
    items: [
      { id: "CC1", title: "Control Environment", description: "Is there a demonstrated commitment to integrity and ethical values?", risk: "HIGH" },
      { id: "CC2", title: "Communication and Information", description: "Is relevant information communicated effectively to support internal control?", risk: "MEDIUM" },
      { id: "CC3", title: "Risk Assessment", description: "Are risks to achieving objectives identified and assessed?", risk: "HIGH" },
      { id: "CC4", title: "Monitoring Activities", description: "Are ongoing evaluations used to ascertain whether the components of internal control are present and functioning?", risk: "HIGH" },
      ...
      { id: "CC6", title: "Logical and Physical Access Controls", description: "Are logical and physical access controls implemented and functioning properly?", risk: "CRITICAL" },
      ...
      { id: "CC8", title: "Change Management", description: "Is a formal change management process in place for systems and data?", risk: "HIGH" },
      { id: "CC9", title: "Risk Mitigation", description: "Are business disruption risks mitigated through continuity and recovery planning?", risk: "MEDIUM" },
    ],
  },
  hipaa: {
    name: "HIPAA Security Rule",
    version: "CFR Part 160 and Subparts A and C of Part 164",
    ...
    items: [
      { id: "164.308", title: "Administrative Safeguards", description: "Are administrative actions, policies, and procedures implemented to manage the selection, development, implementation, and maintenance of security measures?", risk: "HIGH" },
      { id: "164.310", title: "Physical Safeguards", description: "Are physical measures, policies, and procedures implemented to protect electronic information systems and related buildings and equipment?", risk: "HIGH" },
      { id: "164.312", title: "Technical Safeguards", description: "Are technologies and the policies and procedures for its use implemented that protect electronic protected health information and control access to it?", risk: "CRITICAL" },
      { id: "164.314", title: "Organizational Requirements", description: "Are there contracts or other arrangements in place with business associates that meet HIPAA requirements?", risk: "MEDIUM" },
      { id: "164.316", title: "Policies and Procedures and Documentation Requirements", description: "Are reasonable and appropriate policies and procedures implemented to comply with the standards, implementation specifications, or other requirements?", risk: "MEDIUM" },
    ],
  },
  cisv8: {
    ...
    items: [
      { id: "Control 1", title: "Inventory and Control of Enterprise Assets", description: "Are all enterprise assets actively managed (inventoried, tracked, and corrected)?", risk: "HIGH" },
      { id: "Control 2", title: "Inventory and Control of Software Assets", description: "Are all software assets actively managed?", risk: "HIGH" },
      { id: "Control 3", title: "Data Protection", description: "Are processes and technical controls implemented to identify, classify, securely handle, retain, and dispose of data?", risk: "CRITICAL" },
      ...
      { id: "Control 5", title: "Account Management", description: "Are processes and tools used to assign and manage authorization to credentials for user accounts, including administrator accounts, as well as service accounts?", risk: "CRITICAL" },
      ...
      { id: "Control 7", title: "Continuous Vulnerability Management", description: "Is a continuous vulnerability management process developed and implemented?", risk: "HIGH" },
      { id: "Control 8", title: "Audit Log Management", description: "Are audit logs collected, alerted, reviewed, and retained?", risk: "HIGH" },
      { id: "Control 9", title: "Email and Web Browser Protections", description: "Are protections implemented to protect against threats from email and web vectors?", risk: "MEDIUM" },
      { id: "Control 10", title: "Malware Defenses", description: "Is the installation, spread, and execution of malicious applications prevented or controlled?", risk: "HIGH" },
    ],
  },
  gdpr: {
    name: "GDPR",
    ...
    items: [
      ...
      { id: "Art. 25", title: "Data protection by design and by default", description: "Are technical and organizational measures implemented to ensure data protection principles?", risk: "HIGH" },
      ...
      { id: "Art. 33", title: "Notification of a personal data breach to the supervisory authority", description: "Are processes in place to notify the supervisory authority of a data breach within 72 hours?", risk: "HIGH" },
      { id: "Art. 34", title: "Communication of a personal data breach to the data subject", description: "Are processes in place to communicate data breaches to data subjects without undue delay?", risk: "HIGH" },
      { id: "Art. 35", title: "Data protection impact assessment", description: "Is a DPIA carried out where processing is likely to result in a high risk to the rights and freedoms of natural persons?", risk: "MEDIUM" },
    ],
  },
};
