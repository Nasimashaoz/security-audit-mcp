...
export const FRAMEWORKS: Record<string, Framework> = {
  ...
  pcidss: {
    ...
    items: [
      { id: "Req-1", title: "Network Security Controls", description: "Are network security controls (firewalls) configured and maintained to protect cardholder data?", risk: "CRITICAL" },
      ...
      { id: "Req-6", title: "Secure Systems and Software", description: "Are all systems patched and protected against known vulnerabilities? Is bespoke software developed securely?", risk: "HIGH" },
      { id: "Req-7", title: "Restrict Access (Need-to-Know)", description: "Is access to cardholder data strictly limited to individuals whose jobs require it?", risk: "HIGH" },
      { id: "Req-8", title: "Identify Users and Authenticate Access", description: "Is MFA implemented for all access into the CDE? Are unique IDs assigned to each person?", risk: "CRITICAL" },
      { id: "Req-10", title: "Log and Monitor All Access", description: "Are all access to network resources and cardholder data logged, monitored, and retained?", risk: "HIGH" },
    ],
  },
  soc2: {
    name: "SOC 2 Type II",
    ...
    items: [
      ...
      { id: "CC2.1", title: "Communication and Information", description: "Are internal and external communications relevant to security effectively managed?", risk: "LOW" },
      { id: "CC5.1", title: "Logical Access Security", description: "Are logical access controls (e.g., authentication, authorization) in place to protect systems and data?", risk: "CRITICAL" },
      { id: "CC6.1", title: "System Operations", description: "Are systems monitored and anomalies identified in a timely manner?", risk: "HIGH" },
      { id: "CC6.6", title: "Vulnerability Management", description: "Are vulnerabilities identified and mitigated through regular scanning and patching?", risk: "HIGH" },
      { id: "CC7.1", title: "Incident Response", description: "Is there a documented and tested incident response plan to handle security events?", risk: "HIGH" },
      { id: "CC8.1", title: "Change Management", description: "Are all system and software changes authorized, tested, and approved before moving to production?", risk: "MEDIUM" },
    ],
  },
  hipaa: {
    ...
    items: [
      { id: "164.308(a)(1)", title: "Security Management Process", description: "Is a risk analysis performed to identify potential risks to ePHI? Are risk management measures implemented?", risk: "CRITICAL" },
      { id: "164.308(a)(5)", title: "Security Awareness and Training", description: "Are all workforce members trained on security policies and malicious software protection?", risk: "MEDIUM" },
      { id: "164.310(a)(1)", title: "Facility Access Controls", description: "Are physical access controls in place to limit access to facilities housing ePHI?", risk: "HIGH" },
      { id: "164.312(a)(1)", title: "Access Control", description: "Are technical policies implemented allowing access only to authorized persons or software?", risk: "CRITICAL" },
      { id: "164.312(a)(2)(iv)", title: "Encryption and Decryption", description: "Is a mechanism implemented to encrypt and decrypt ePHI where appropriate?", risk: "CRITICAL" },
      { id: "164.312(b)", title: "Audit Controls", description: "Are hardware, software, and procedural mechanisms implemented that record and examine activity in systems that contain ePHI?", risk: "HIGH" },
    ],
  },
  cisv8: {
    name: "CIS Controls",
    ...
    items: [
      ...
      { id: "CIS-2", title: "Inventory and Control of Software Assets", description: "Is there an inventory of all authorized software? Is unauthorized software prevented from executing?", risk: "HIGH" },
      ...
      { id: "CIS-4", title: "Secure Configuration of Enterprise Assets", description: "Are secure configurations established and maintained for all enterprise assets and software?", risk: "HIGH" },
      ...
      { id: "CIS-6", title: "Access Control Management", description: "Is access to enterprise assets and software restricted to authorized users and processes (MFA, Need-to-know)?", risk: "CRITICAL" },
      { id: "CIS-7", title: "Continuous Vulnerability Management", description: "Are vulnerabilities continuously assessed and tracked on all enterprise assets?", risk: "HIGH" },
  ...
  gdpr: {
    name: "GDPR",
    version: "EU 2016/679",
    description: "General Data Protection Regulation. Protects the data and privacy of all individuals within the European Union (EU) and the European Economic Area (EEA).",
    items: [
      ...
      { id: "Art-25", title: "Data protection by design and by default", description: "Are data protection principles integrated into business processes and new systems from the design phase?", risk: "HIGH" },
      { id: "Art-28", title: "Processor", description: "Are there contracts in place with third-party processors ensuring they meet GDPR requirements?", risk: "MEDIUM" },
      ...
      { id: "Art-32", title: "Security of processing", description: "Are technical and organizational measures implemented to ensure a level of security appropriate to the risk (e.g., encryption, pseudonymisation)?", risk: "CRITICAL" },
      { id: "Art-33", title: "Notification of a personal data breach to the supervisory authority", description: "Is there a process to detect, report, and investigate personal data breaches within 72 hours?", risk: "CRITICAL" },
      { id: "Art-35", title: "Data protection impact assessment", description: "Are Data Protection Impact Assessments (DPIAs) conducted for processing operations likely to result in a high risk to the rights of individuals?", risk: "HIGH" },
    ],
  },
};
