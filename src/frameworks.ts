...
export const FRAMEWORKS: Record<string, Framework> = {
  ...
  pcidss: {
    name: "PCI-DSS",
    version: "4.0",
    description: "Payment Card Industry Data Security Standard, required for handling cardholder data.",
    items: [
      { id: "PCI-1", title: "Install and Maintain Network Security Controls", description: "Are network security controls (NSCs) installed and maintained to protect cardholder data?", risk: "CRITICAL" },
      { id: "PCI-2", title: "Apply Secure Configurations to All System Components", description: "Are vendor-supplied default passwords changed and are secure configurations maintained?", risk: "HIGH" },
      { id: "PCI-3", title: "Protect Stored Account Data", description: "Is stored cardholder data, including PANs, securely protected?", risk: "CRITICAL" },
      { id: "PCI-4", title: "Protect Account Data in Transit", description: "Is cardholder data encrypted with strong cryptography during transmission over open, public networks?", risk: "CRITICAL" },
      { id: "PCI-8", title: "Identify Users and Authenticate Access", description: "Is access to system components identified and authenticated using unique IDs and multi-factor authentication?", risk: "HIGH" },
    ],
  },
  soc2: {
    name: "SOC 2",
    ...
    items: [
      ...
      { id: "CC5", title: "Logical and Physical Access Controls", description: "Are logical and physical access restricted to authorized individuals?", risk: "HIGH" },
      { id: "CC6", title: "System Operations", description: "Are system operations continuously monitored for anomalous activity?", risk: "HIGH" },
      { id: "CC7", title: "Change Management", description: "Are changes to systems and software appropriately authorized, tested, and implemented?", risk: "MEDIUM" },
      { id: "CC8", title: "Risk Mitigation", description: "Are risk mitigation strategies, including vendor management, implemented and evaluated?", risk: "MEDIUM" },
    ],
  },
  hipaa: {
    name: "HIPAA Security Rule",
    version: "1996",
    description: "Health Insurance Portability and Accountability Act, safeguarding electronic protected health information (ePHI).",
    items: [
      { id: "HIPAA-1", title: "Access Control", description: "Are there technical policies and procedures for electronic information systems that maintain ePHI?", risk: "CRITICAL" },
      { id: "HIPAA-2", title: "Audit Controls", description: "Are hardware, software, and/or procedural mechanisms in place to record and examine access and other activity?", risk: "HIGH" },
      { id: "HIPAA-3", title: "Integrity", description: "Are there policies and procedures to protect ePHI from improper alteration or destruction?", risk: "HIGH" },
      { id: "HIPAA-4", title: "Person or Entity Authentication", description: "Are procedures implemented to verify that a person or entity seeking access to ePHI is the one claimed?", risk: "HIGH" },
      { id: "HIPAA-5", title: "Transmission Security", description: "Are technical security measures implemented to guard against unauthorized access to ePHI being transmitted?", risk: "CRITICAL" },
    ],
  },
  cisv8: {
    name: "CIS Controls",
    version: "v8",
    description: "Center for Internet Security Controls, a prioritized set of actions to protect organizations from known cyber attacks.",
    items: [
  ...
  gdpr: {
    ...
    items: [
      { id: "GDPR-5", title: "Principles relating to processing of personal data", description: "Is personal data processed lawfully, fairly, and transparently?", risk: "HIGH" },
      { id: "GDPR-25", title: "Data protection by design and by default", description: "Are data protection principles integrated into the development of business processes and systems?", risk: "HIGH" },
      { id: "GDPR-32", title: "Security of processing", description: "Are appropriate technical and organizational measures implemented to ensure a level of security appropriate to the risk?", risk: "CRITICAL" },
      { id: "GDPR-33", title: "Notification of a personal data breach", description: "Is there a process to notify the supervisory authority of a data breach within 72 hours?", risk: "HIGH" },
      { id: "GDPR-35", title: "Data protection impact assessment", description: "Are DPIAs conducted for processing operations likely to result in a high risk to rights and freedoms?", risk: "MEDIUM" },
    ],
  },
};
