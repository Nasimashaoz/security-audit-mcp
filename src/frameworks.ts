...
export const FRAMEWORKS: Record<string, Framework> = {
  ...
  pcidss: {
    ...
    items: [
      { id: "1.1.1", title: "Network Security Controls", description: "Are network security controls configured and maintained?", risk: "HIGH" },
      { id: "3.2.1", title: "Protect Stored Account Data", description: "Is stored account data kept to a minimum and protected?", risk: "CRITICAL" },
      { id: "4.2.1", title: "Strong Cryptography", description: "Is strong cryptography used during transmission over open networks?", risk: "CRITICAL" },
      { id: "6.2.2", title: "Protect Software from Vulnerabilities", description: "Are critical security patches installed within one month of release?", risk: "HIGH" },
      { id: "8.2.1", title: "Identify Users", description: "Are all users assigned a unique ID before access is allowed?", risk: "HIGH" },
  ...
  soc2: {
    ...
    items: [
      ...
      { id: "CC2.1", title: "Communication and Information", description: "Does the entity obtain or generate relevant, quality information to support the functioning of internal control?", risk: "MEDIUM" },
      { id: "CC5.1", title: "Logical and Physical Access Controls", description: "Are logical access security software, infrastructure, and architectures implemented to protect information assets?", risk: "CRITICAL" },
      { id: "CC6.1", title: "System Operations", description: "Are logical access security controls implemented over infrastructure, applications, and data?", risk: "HIGH" },
      { id: "CC7.1", title: "Change Management", description: "Are changes to systems and software authorized, tested, and approved before migration to production?", risk: "HIGH" },
      { id: "CC8.1", title: "Risk Mitigation", description: "Are risks to the achievement of objectives identified, analyzed, and mitigated?", risk: "HIGH" },
    ],
  },
  hipaa: {
    ...
    items: [
      { id: "164.308(a)(1)", title: "Security Management Process", description: "Is a risk analysis conducted to assess vulnerabilities to ePHI?", risk: "CRITICAL" },
      ...
      { id: "164.312(a)(1)", title: "Access Control", description: "Are policies implemented to grant access to ePHI only to authorized persons?", risk: "HIGH" },
      ...
      { id: "164.312(e)(1)", title: "Transmission Security", description: "Are technical security measures implemented to guard against unauthorized access to ePHI being transmitted over an electronic network?", risk: "HIGH" },
    ],
  },
  cisv8: {
    name: "CIS Controls",
    version: "v8",
    description: "Center for Internet Security Critical Security Controls, a prioritized set of actions to protect organizations and data.",
    items: [
      { id: "1.1", title: "Establish and Maintain Detailed Enterprise Asset Inventory", description: "Is an accurate and up-to-date inventory of all enterprise assets maintained?", risk: "HIGH" },
      { id: "2.1", title: "Establish and Maintain a Software Inventory", description: "Is a detailed inventory of all software maintained?", risk: "HIGH" },
      { id: "3.1", title: "Establish and Maintain a Data Management Process", description: "Is a process established and maintained for managing enterprise data?", risk: "HIGH" },
      { id: "4.1", title: "Establish and Maintain a Secure Configuration Process", description: "Is a secure configuration process established and maintained for all enterprise assets?", risk: "HIGH" },
      { id: "5.1", title: "Establish and Maintain an Account Management Process", description: "Is an account management process established and maintained?", risk: "HIGH" },
      { id: "6.1", title: "Establish an Access Granting Process", description: "Is a process established to grant access to enterprise assets upon hire or role change?", risk: "CRITICAL" },
    ],
  },
  gdpr: {
    name: "GDPR",
    ...
    items: [
      { id: "Art.5(1)(f)", title: "Integrity and Confidentiality", description: "Is personal data processed in a manner that ensures appropriate security?", risk: "CRITICAL" },
      { id: "Art.25(1)", title: "Data Protection by Design and by Default", description: "Are appropriate technical and organizational measures implemented to embed data protection principles?", risk: "HIGH" },
      { id: "Art.28(1)", title: "Processor Agreements", description: "Are written agreements in place with all processors handling personal data?", risk: "MEDIUM" },
      { id: "Art.30(1)", title: "Records of Processing Activities", description: "Is a record of processing activities maintained?", risk: "MEDIUM" },
      { id: "Art.32(1)", title: "Security of Processing", description: "Are appropriate technical and organizational measures implemented to ensure a level of security appropriate to the risk?", risk: "HIGH" },
      { id: "Art.33(1)", title: "Notification of a Personal Data Breach", description: "Is a process established to notify the supervisory authority of a data breach within 72 hours?", risk: "HIGH" },
    ],
  },
  iso27001: {
    name: "ISO 27001",
