...
export const FRAMEWORKS: Record<string, Framework> = {
  ...
  "pci-dss": {
    ...
    items: [
      ...
      { id: "req-3", title: "Protect Stored Account Data", description: "Is stored cardholder data encrypted and retained only as long as necessary?", risk: "CRITICAL" },
      { id: "req-4", title: "Protect Cryptography During Transmission", description: "Is cardholder data encrypted during transmission over open, public networks?", risk: "CRITICAL" },
      { id: "req-5", title: "Protect All Systems and Networks from Malicious Software", description: "Are anti-malware solutions deployed and kept up to date?", risk: "HIGH" },
      { id: "req-6", title: "Develop and Maintain Secure Systems and Software", description: "Are security vulnerabilities identified and addressed? Are critical patches applied within 30 days?", risk: "HIGH" },
      { id: "req-7", title: "Restrict Access to System Components and Cardholder Data", description: "Is access limited to only those individuals whose job requires such access?", risk: "CRITICAL" },
      { id: "req-8", title: "Identify Users and Authenticate Access", description: "Are unique IDs assigned to all users? Is MFA implemented for all access to the CDE?", risk: "CRITICAL" },
      { id: "req-9", title: "Restrict Physical Access to Cardholder Data", description: "Are facility entry controls used to limit physical access?", risk: "HIGH" },
      { id: "req-10", title: "Log and Monitor All Access", description: "Are audit logs maintained and reviewed regularly to identify anomalies?", risk: "HIGH" },
      { id: "req-11", title: "Test Security of Systems and Networks Regularly", description: "Are internal and external vulnerability scans and penetration tests performed?", risk: "HIGH" },
      { id: "req-12", title: "Support Information Security with Organizational Policies", description: "Is a comprehensive information security policy established, published, and maintained?", risk: "MEDIUM" },
    ],
  },
  soc2: {
    name: "SOC 2 Type II",
    ...
    items: [
      ...
      { id: "CC6", title: "Logical and Physical Access Controls", description: "Does the entity implement logical and physical access controls to prevent unauthorized access?", risk: "CRITICAL" },
      { id: "CC7", title: "System Operations", description: "Does the entity monitor system operations and identify, respond to, and mitigate security events?", risk: "HIGH" },
      ...
      { id: "CC9", title: "Risk Mitigation", description: "Does the entity identify, select, and develop risk mitigation activities for risks arising from potential business disruptions?", risk: "HIGH" },
    ],
  },
  hipaa: {
    ...
    items: [
      { id: "164.308", title: "Administrative Safeguards", description: "Are security management processes in place, including risk analysis, risk management, and sanction policies?", risk: "HIGH" },
      ...
      { id: "164.310", title: "Physical Safeguards", description: "Are physical access controls implemented for facilities and workstations storing ePHI?", risk: "HIGH" },
      ...
      { id: "164.312(b)", title: "Audit Controls", description: "Are hardware, software, and/or procedural mechanisms in place to record and examine access and other activity in systems that contain ePHI?", risk: "HIGH" },
  ...
  "cis-v8": {
    ...
    items: [
      { id: "CIS-1", title: "Inventory and Control of Enterprise Assets", description: "Are all enterprise assets actively managed (inventoried, tracked, and corrected) so that only authorized assets are given access?", risk: "HIGH" },
      { id: "CIS-2", title: "Inventory and Control of Software Assets", description: "Are all software assets actively managed so that only authorized software is installed and can execute?", risk: "HIGH" },
      ...
      { id: "CIS-4", title: "Secure Configuration of Enterprise Assets and Software", description: "Is the secure configuration of enterprise assets and software established and maintained?", risk: "HIGH" },
      ...
      { id: "CIS-7", title: "Continuous Vulnerability Management", description: "Is a continuous vulnerability management plan developed and maintained to identify and remediate vulnerabilities?", risk: "HIGH" },
  ...
  gdpr: {
    ...
    items: [
      ...
      { id: "Art-25", title: "Data protection by design and by default", description: "Are appropriate technical and organizational measures implemented to ensure data protection principles are integrated into processing activities?", risk: "HIGH" },
      { id: "Art-28", title: "Processor", description: "Are processing activities carried out by processors governed by a contract ensuring the protection of personal data?", risk: "HIGH" },
      { id: "Art-30", title: "Records of processing activities", description: "Is a record of processing activities maintained under the organization's responsibility?", risk: "MEDIUM" },
      { id: "Art-32", title: "Security of processing", description: "Are appropriate technical and organizational measures, such as pseudonymisation and encryption, implemented to ensure a level of security appropriate to the risk?", risk: "CRITICAL" },
      { id: "Art-33", title: "Notification of a personal data breach to the supervisory authority", description: "Are processes in place to notify the competent supervisory authority of a personal data breach without undue delay (within 72 hours)?", risk: "CRITICAL" },
      { id: "Art-34", title: "Communication of a personal data breach to the data subject", description: "Are processes in place to communicate personal data breaches to affected data subjects without undue delay when the risk is high?", risk: "HIGH" },
      { id: "Art-35", title: "Data protection impact assessment", description: "Are data protection impact assessments carried out for processing operations likely to result in a high risk to the rights and freedoms of natural persons?", risk: "HIGH" },
    ],
  },
};
