...
export const FRAMEWORKS: Record<string, Framework> = {
  ...
  pcidss: {
    ...
    items: [
      ...
      { id: "Req-3", title: "Protect Stored Account Data", description: "Is stored cardholder data protected and encrypted where required?", risk: "CRITICAL" },
      ...
      { id: "Req-6", title: "Secure Systems and Software", description: "Are secure systems and software developed and maintained, and are security patches installed promptly?", risk: "HIGH" },
      { id: "Req-8", title: "Identify and Authenticate Access", description: "Are users identified and authenticated before being granted access to system components?", risk: "HIGH" },
    ],
  },
  soc2: {
    name: "SOC 2 Type II",
    ...
    items: [
      ...
      { id: "CC6.1", title: "System Operations", description: "Does the entity implement logical access security software to protect against internal and external threats?", risk: "HIGH" },
      { id: "CC7.1", title: "System Monitoring", description: "Is the system monitored for anomalies that indicate malicious acts, natural disasters, and errors?", risk: "HIGH" },
      { id: "CC8.1", title: "Change Management", description: "Are changes to IT infrastructure, data, software, and procedures authorized and tested?", risk: "MEDIUM" },
    ],
  },
  hipaa: {
    ...
    items: [
      ...
      { id: "164.308(a)(5)", title: "Security Awareness and Training", description: "Is a security awareness and training program implemented for all members of its workforce?", risk: "HIGH" },
      { id: "164.312(a)(1)", title: "Access Control", description: "Are technical policies and procedures implemented for electronic information systems that maintain ePHI to allow access only to those authorized?", risk: "CRITICAL" },
  ...
  cis: {
    ...
    items: [
      ...
      { id: "CIS-5", title: "Account Management", description: "Use processes and tools to assign and manage authorization to credentials for user accounts, including administrator accounts.", risk: "HIGH" },
