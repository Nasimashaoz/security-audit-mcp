...
export const FRAMEWORKS: Record<string, Framework> = {
  ...
  pcidss: {
    ...
    items: [
      ...
      { id: "Req-3", title: "Protect Stored Account Data", description: "Is stored cardholder data kept to a minimum and protected with strong cryptography?", risk: "CRITICAL" },
      { id: "Req-4", title: "Protect Cardholder Data with Strong Cryptography During Transmission", description: "Is sensitive data encrypted during transmission over open, public networks?", risk: "CRITICAL" },
      ...
      { id: "Req-6", title: "Develop and Maintain Secure Systems and Software", description: "Are critical security patches applied within one month, and secure coding guidelines followed?", risk: "HIGH" },
      { id: "Req-7", title: "Restrict Access to System Components and Cardholder Data by Business Need to Know", description: "Is access to cardholder data limited to only those individuals whose jobs require it?", risk: "CRITICAL" },
      { id: "Req-8", title: "Identify Users and Authenticate Access to System Components", description: "Are unique IDs and MFA used for access to the cardholder data environment?", risk: "CRITICAL" },
      { id: "Req-9", title: "Restrict Physical Access to Cardholder Data", description: "Is physical access to systems storing or processing cardholder data restricted and monitored?", risk: "MEDIUM" },
      { id: "Req-10", title: "Log and Monitor All Access to System Components and Cardholder Data", description: "Are audit trails enabled and reviewed to track access and security events?", risk: "HIGH" },
      ...
      { id: "Req-12", title: "Support Information Security with Organizational Policies and Programs", description: "Is a comprehensive security policy maintained, published, and disseminated to all personnel?", risk: "MEDIUM" }
    ],
  },
  soc2: {
    name: "SOC 2",
    ...
    items: [
      ...
      { id: "CC2", title: "Communication and Information", description: "Is relevant information generated and communicated to support internal control functioning?", risk: "MEDIUM" },
      { id: "CC3", title: "Risk Assessment", description: "Does the organization identify and assess risks related to objectives?", risk: "HIGH" },
      { id: "CC4", title: "Monitoring Activities", description: "Are internal controls evaluated and deficiencies communicated to responsible parties?", risk: "HIGH" },
      { id: "CC5", title: "Control Activities", description: "Are control activities selected and developed to mitigate risks?", risk: "HIGH" },
      { id: "CC6", title: "Logical and Physical Access", description: "Are logical and physical access controls implemented to prevent unauthorized access?", risk: "CRITICAL" },
      { id: "CC7", title: "System Operations", description: "Is system operation monitored and are deviations managed?", risk: "HIGH" },
      { id: "CC8", title: "Change Management", description: "Are system changes authorized, designed, developed, tested, and approved?", risk: "HIGH" },
      { id: "CC9", title: "Risk Mitigation", description: "Are activities implemented to mitigate risks related to business disruptions?", risk: "MEDIUM" }
    ],
  },
  hipaa: {
    ...
    items: [
      { id: "164.308(a)(1)", title: "Security Management Process", description: "Are risk analysis and risk management processes implemented to protect ePHI?", risk: "CRITICAL" },
      ...
      { id: "164.308(a)(4)", title: "Information Access Management", description: "Is access to ePHI authorized and properly maintained?", risk: "CRITICAL" },
      ...
      { id: "164.310(b)", title: "Workstation Use", description: "Are policies governing the proper use of and access to workstations established?", risk: "MEDIUM" },
      ...
      { id: "164.310(d)(1)", title: "Device and Media Controls", description: "Are procedures for the receipt, removal, and movement of hardware and electronic media containing ePHI implemented?", risk: "MEDIUM" },
      { id: "164.312(a)(1)", title: "Access Control", description: "Are technical policies and procedures implemented to allow only authorized access to ePHI?", risk: "CRITICAL" },
  ...
  cisv8: {
    ...
    items: [
      ...
      { id: "CIS-5", title: "Account Management", description: "Are processes established and maintained to assign and manage authorization to credentials for user accounts?", risk: "CRITICAL" },
      { id: "CIS-6", title: "Access Control Management", description: "Is access to assets and data restricted and managed (e.g., using least privilege and MFA)?", risk: "CRITICAL" },
      { id: "CIS-7", title: "Continuous Vulnerability Management", description: "Are new information, processes, and tools developed to identify and remediate vulnerabilities?", risk: "HIGH" },
      { id: "CIS-8", title: "Audit Log Management", description: "Are audit logs collected, alerted on, reviewed, and retained?", risk: "HIGH" },
      { id: "CIS-9", title: "Email and Web Browser Protections", description: "Are protections implemented against threats spread through email and web vectors?", risk: "HIGH" },
      { id: "CIS-10", title: "Malware Defenses", description: "Are malicious code execution prevented, or controlled?", risk: "HIGH" },
      { id: "CIS-11", title: "Data Recovery", description: "Are data recovery practices sufficient and tested?", risk: "HIGH" },
      { id: "CIS-12", title: "Network Infrastructure Management", description: "Is network infrastructure securely established, actively managed, and defended?", risk: "HIGH" },
      { id: "CIS-13", title: "Network Monitoring and Defense", description: "Are networks monitored continuously for malicious activity?", risk: "HIGH" },
      ...
      { id: "CIS-15", title: "Service Provider Management", description: "Are service providers evaluated, selected, and managed properly regarding security?", risk: "MEDIUM" },
      { id: "CIS-16", title: "Application Software Security", description: "Is the security lifecycle of in-house developed, hosted, or acquired software managed?", risk: "HIGH" },
      { id: "CIS-17", title: "Incident Response Management", description: "Is an incident response process established and maintained?", risk: "CRITICAL" },
      { id: "CIS-18", title: "Penetration Testing", description: "Are organizational defenses tested by simulating attacker objectives?", risk: "HIGH" }
    ],
  },
};
