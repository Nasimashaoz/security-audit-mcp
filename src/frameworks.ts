...
export const FRAMEWORKS: Record<string, Framework> = {
  ...
  pcidss: {
    ...
    items: [
      { id: "1.2", title: "Network Security Controls", description: "Are network security controls configured to restrict traffic to only what is necessary for the cardholder data environment?", risk: "CRITICAL" },
      { id: "3.2", title: "Protect Stored Account Data", description: "Is stored account data kept to a minimum and encrypted at rest?", risk: "CRITICAL" },
      { id: "4.2", title: "Protect Data in Transit", description: "Is account data encrypted during transmission over open, public networks using strong cryptography?", risk: "HIGH" },
      { id: "6.2", title: "Bespoke and Custom Software", description: "Is custom software developed securely, with vulnerabilities identified and addressed?", risk: "HIGH" },
      { id: "8.2", title: "User Identification", description: "Are all users assigned a unique ID before access is allowed to system components or cardholder data?", risk: "HIGH" },
      { id: "8.4", title: "Multi-Factor Authentication", description: "Is multi-factor authentication implemented for all access into the cardholder data environment?", risk: "CRITICAL" },
      { id: "10.2", title: "Audit Logs", description: "Are audit logs implemented to link all access to system components to individual users?", risk: "HIGH" },
    ],
  },
  soc2: {
    name: "SOC 2 Type II",
    ...
    items: [
      ...
      { id: "CC6.3", title: "Access Revocation", description: "Are access rights revoked immediately upon termination of employment or when access is no longer required?", risk: "HIGH" },
      { id: "CC7.1", title: "System Monitoring", description: "Is the system continuously monitored to detect unauthorized or anomalous activity?", risk: "HIGH" },
      { id: "CC8.1", title: "Change Management", description: "Are changes to systems, infrastructure, and software managed through a formalized change control process?", risk: "HIGH" },
    ],
  },
  hipaa: {
    ...
    items: [
      { id: "164.308(a)(1)", title: "Security Management Process", description: "Is a risk analysis conducted to assess potential risks and vulnerabilities to the confidentiality, integrity, and availability of ePHI?", risk: "CRITICAL" },
      ...
      { id: "164.312(a)(1)", title: "Access Control", description: "Are technical policies and procedures implemented for electronic information systems that maintain ePHI to allow access only to authorized persons or software?", risk: "CRITICAL" },
  ...
  cis_v8: {
    ...
    items: [
      { id: "1", title: "Inventory and Control of Enterprise Assets", description: "Are enterprise assets tracked and managed to ensure only authorized assets are given access?", risk: "HIGH" },
      { id: "2", title: "Inventory and Control of Software Assets", description: "Are software assets managed to ensure only authorized software is installed and executing?", risk: "HIGH" },
      { id: "3", title: "Data Protection", description: "Are processes and technical controls implemented to identify, classify, securely handle, retain, and dispose of data?", risk: "CRITICAL" },
      { id: "4", title: "Secure Configuration", description: "Are enterprise assets and software securely configured and managed?", risk: "HIGH" },
      { id: "5", title: "Account Management", description: "Are accounts for enterprise assets and software actively managed, including assignment and revocation?", risk: "HIGH" },
      { id: "6", title: "Access Control Management", description: "Are access credentials managed to ensure only authorized entities access enterprise assets and software?", risk: "CRITICAL" },
      { id: "8", title: "Audit Log Management", description: "Are audit logs collected, analyzed, and retained?", risk: "HIGH" },
    ],
  },
  gdpr: {
    name: "GDPR",
    version: "2016/679",
    description: "General Data Protection Regulation governing data protection and privacy in the European Union.",
    items: [
      ...
      { id: "Art. 25", title: "Data protection by design and by default", description: "Are appropriate technical and organisational measures implemented to ensure that only personal data necessary for each specific purpose are processed?", risk: "HIGH" },
      { id: "Art. 32", title: "Security of processing", description: "Are appropriate technical and organisational measures implemented to ensure a level of security appropriate to the risk, including encryption?", risk: "CRITICAL" },
      { id: "Art. 33", title: "Notification of a personal data breach", description: "Are procedures in place to notify the supervisory authority of a personal data breach within 72 hours?", risk: "HIGH" },
      { id: "Art. 35", title: "Data protection impact assessment", description: "Is a DPIA carried out where a type of processing is likely to result in a high risk to the rights and freedoms of natural persons?", risk: "MEDIUM" },
    ],
  },
};
