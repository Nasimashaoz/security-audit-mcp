...
export const FRAMEWORKS: Record<string, Framework> = {
  ...
  cis_v8: {
    ...
    items: [
      ...
      { id: "CIS-2", title: "Inventory and Control of Software Assets", description: "Is unauthorized software prevented from executing?", risk: "HIGH" },
      { id: "CIS-3", title: "Data Protection", description: "Is sensitive data identified, classified, and protected?", risk: "CRITICAL" },
      ...
      { id: "CIS-5", title: "Account Management", description: "Are administrative and user accounts actively managed?", risk: "HIGH" },
      { id: "CIS-6", title: "Access Control Management", description: "Is access to systems limited based on the principle of least privilege?", risk: "CRITICAL" },
    ],
  },
  pci_dss: {
    name: "PCI-DSS",
    ...
    items: [
      { id: "PCI-1", title: "Install and Maintain Network Security Controls", description: "Are firewalls configured to protect cardholder data?", risk: "CRITICAL" },
      { id: "PCI-2", title: "Apply Secure Configurations to All System Components", description: "Are vendor-supplied defaults changed before installing a system?", risk: "HIGH" },
      { id: "PCI-3", title: "Protect Stored Account Data", description: "Is stored cardholder data encrypted?", risk: "CRITICAL" },
      { id: "PCI-4", title: "Protect Cryptography of Account Data in Transit", description: "Is cardholder data encrypted across open, public networks?", risk: "CRITICAL" },
      { id: "PCI-5", title: "Protect All Systems and Networks from Malicious Software", description: "Is anti-malware software deployed and updated?", risk: "HIGH" },
      { id: "PCI-6", title: "Develop and Maintain Secure Systems and Software", description: "Are critical security patches installed within one month of release?", risk: "HIGH" },
    ],
  },
  soc2: {
    name: "SOC 2",
    ...
    items: [
      ...
      { id: "CC2", title: "Communication and Information", description: "Are internal and external communications regarding security effective?", risk: "MEDIUM" },
      { id: "CC3", title: "Risk Assessment", description: "Are risks to the achievement of objectives identified and analyzed?", risk: "HIGH" },
      { id: "CC4", title: "Monitoring Activities", description: "Are internal controls monitored and evaluated?", risk: "HIGH" },
      { id: "CC5", title: "Control Activities", description: "Are control activities developed to mitigate risks?", risk: "HIGH" },
      { id: "CC6", title: "Logical and Physical Access Controls", description: "Is unauthorized physical and logical access prevented?", risk: "CRITICAL" },
    ],
  },
  hipaa: {
    name: "HIPAA",
    ...
    items: [
      { id: "HIPAA-1", title: "Security Management Process", description: "Are risk analyses conducted to assess ePHI risks?", risk: "CRITICAL" },
      { id: "HIPAA-2", title: "Assigned Security Responsibility", description: "Is a security official designated?", risk: "MEDIUM" },
      { id: "HIPAA-3", title: "Workforce Security", description: "Are procedures in place for authorizing access to ePHI?", risk: "HIGH" },
      { id: "HIPAA-4", title: "Information Access Management", description: "Is access to ePHI strictly controlled and monitored?", risk: "CRITICAL" },
      { id: "HIPAA-5", title: "Security Awareness and Training", description: "Are all workforce members trained on security policies?", risk: "MEDIUM" },
      { id: "HIPAA-6", title: "Security Incident Procedures", description: "Are security incidents identified, reported, and responded to?", risk: "HIGH" },
    ],
  },
};
