...
export const FRAMEWORKS: Record<string, Framework> = {
  ...
  pcidss: {
    ...
    items: [
      { id: "Req-1", title: "Install and Maintain Network Security Controls", description: "Are firewalls and network security controls configured to protect cardholder data?", risk: "CRITICAL" },
      { id: "Req-2", title: "Apply Secure Configurations to All System Components", description: "Are default passwords changed and are secure configurations maintained?", risk: "HIGH" },
      ...
      { id: "Req-5", title: "Protect All Systems and Networks from Malicious Software", description: "Is anti-malware software active, updated, and generating logs?", risk: "HIGH" },
      { id: "Req-6", title: "Develop and Maintain Secure Systems and Software", description: "Are security vulnerabilities identified and addressed? Are security patches applied promptly?", risk: "CRITICAL" },
      { id: "Req-7", title: "Restrict Access to System Components and Cardholder Data", description: "Is access to cardholder data limited by business need-to-know?", risk: "HIGH" },
      { id: "Req-8", title: "Identify Users and Authenticate Access", description: "Is MFA used for access? Are generic or shared IDs prohibited?", risk: "HIGH" },
      { id: "Req-9", title: "Restrict Physical Access to Cardholder Data", description: "Is physical access to systems storing cardholder data restricted and monitored?", risk: "MEDIUM" },
      { id: "Req-10", title: "Log and Monitor All Access", description: "Are access logs recorded, protected, and regularly reviewed?", risk: "HIGH" },
      ...
      { id: "Req-12", title: "Support Information Security with Policies and Programs", description: "Is there a comprehensive information security policy established and maintained?", risk: "MEDIUM" },
    ],
  },
  soc2: {
    name: "SOC 2 Type II",
    ...
    items: [
      { id: "CC1", title: "Control Environment", description: "Is there a commitment to integrity and ethical values? Does the board exercise oversight?", risk: "MEDIUM" },
      { id: "CC2", title: "Communication and Information", description: "Is relevant information generated and communicated internally and externally to support the functioning of internal control?", risk: "MEDIUM" },
      { id: "CC3", title: "Risk Assessment", description: "Are risks to the achievement of objectives identified and assessed?", risk: "HIGH" },
      ...
      { id: "CC6", title: "Logical and Physical Access Controls", description: "Is logical and physical access restricted to authorized individuals?", risk: "CRITICAL" },
      { id: "CC7", title: "System Operations", description: "Are system operations monitored, and are deviations from established baselines identified and responded to?", risk: "HIGH" },
      { id: "CC8", title: "Change Management", description: "Are changes to systems, data, and software authorized, designed, developed, configured, documented, tested, approved, and implemented?", risk: "HIGH" },
      { id: "CC9", title: "Risk Mitigation", description: "Are business disruption risks mitigated through continuity planning?", risk: "MEDIUM" },
    ],
  },
  hipaa: {
    ...
    items: [
      { id: "164.308(a)(1)", title: "Security Management Process", description: "Are risk analyses conducted, and are risk management policies implemented?", risk: "CRITICAL" },
      ...
      { id: "164.308(a)(5)", title: "Security Awareness and Training", description: "Is security awareness training provided for all workforce members?", risk: "MEDIUM" },
      { id: "164.308(a)(6)", title: "Security Incident Procedures", description: "Are policies implemented to address security incidents?", risk: "HIGH" },
      ...
      { id: "164.310(a)(1)", title: "Facility Access Controls", description: "Are physical access controls implemented for facilities storing ePHI?", risk: "MEDIUM" },
      { id: "164.310(d)(1)", title: "Device and Media Controls", description: "Are procedures implemented for the receipt, routing, and disposal of hardware and electronic media containing ePHI?", risk: "MEDIUM" },
      ...
      { id: "164.312(b)", title: "Audit Controls", description: "Are mechanisms implemented to record and examine activity in information systems that contain or use ePHI?", risk: "HIGH" },
  ...
  cisv8: {
    ...
    items: [
      { id: "Control 1", title: "Inventory and Control of Enterprise Assets", description: "Are enterprise assets actively managed (inventoried, tracked, and corrected)?", risk: "MEDIUM" },
      { id: "Control 2", title: "Inventory and Control of Software Assets", description: "Are software assets actively managed?", risk: "MEDIUM" },
      ...
      { id: "Control 4", title: "Secure Configuration of Enterprise Assets and Software", description: "Are secure configurations established and maintained?", risk: "HIGH" },
      ...
      { id: "Control 7", title: "Continuous Vulnerability Management", description: "Is a continuous vulnerability management process established?", risk: "HIGH" },
      { id: "Control 8", title: "Audit Log Management", description: "Are audit logs collected, alerted, reviewed, and retained?", risk: "HIGH" },
      { id: "Control 9", title: "Email and Web Browser Protections", description: "Are protections implemented against threats delivered through email and web browsers?", risk: "MEDIUM" },
      { id: "Control 10", title: "Malware Defenses", description: "Are malware defenses implemented to prevent or control the installation, spread, and execution of malicious applications?", risk: "HIGH" },
    ],
  },
  gdpr: {
    name: "GDPR",
    ...
    items: [
      ...
      { id: "Art-6", title: "Lawfulness of processing", description: "Is there a lawful basis for processing personal data (e.g., consent, contract)?", risk: "CRITICAL" },
      { id: "Art-7", title: "Conditions for consent", description: "Can the organization demonstrate that the data subject has consented to processing of their personal data?", risk: "HIGH" },
      { id: "Art-15", title: "Right of access by the data subject", description: "Can data subjects access their personal data and information about how it is processed?", risk: "MEDIUM" },
      { id: "Art-17", title: "Right to erasure ('right to be forgotten')", description: "Can personal data be erased without undue delay under certain circumstances?", risk: "MEDIUM" },
      ...
      { id: "Art-32", title: "Security of processing", description: "Are technical and organisational measures implemented to ensure a level of security appropriate to the risk (e.g., encryption)?", risk: "CRITICAL" },
      ...
      { id: "Art-34", title: "Communication of a personal data breach to the data subject", description: "Is there a process to communicate high-risk data breaches to data subjects without undue delay?", risk: "HIGH" },
      { id: "Art-35", title: "Data protection impact assessment", description: "Are DPIAs carried out for processing operations likely to result in a high risk to the rights and freedoms of natural persons?", risk: "HIGH" },
    ],
  },
};
