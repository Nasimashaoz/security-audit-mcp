...
export const FRAMEWORKS: Record<string, Framework> = {
  ...
  pcidss: {
    ...
    items: [
      ...
      { id: "Req-4", title: "Cryptography during Transmission", description: "Is cardholder data protected with strong cryptography during transmission?", risk: "CRITICAL" },
      { id: "Req-5", title: "Protect Systems from Malware", description: "Are all systems protected from malicious software and updated?", risk: "HIGH" },
      ...
      { id: "Req-11", title: "Test Security of Systems", description: "Are security of systems and networks tested regularly?", risk: "HIGH" },
      { id: "Req-12", title: "Support Information Security", description: "Is information security supported with organizational policies and programs?", risk: "MEDIUM" }
    ],
  },
  soc2: {
    name: "SOC 2",
    version: "Type II",
    description: "Service Organization Control 2. Framework for managing customer data based on security, availability, processing integrity, confidentiality, and privacy.",
    items: [
      { id: "CC1", title: "Control Environment", description: "Does the entity demonstrate a commitment to integrity and ethical values?", risk: "HIGH" },
      ...
      { id: "CC3", title: "Risk Assessment", description: "Does the entity specify objectives to enable the identification and assessment of risks?", risk: "HIGH" },
      { id: "CC4", title: "Monitoring Activities", description: "Are ongoing and/or separate evaluations performed to ascertain whether controls are present and functioning?", risk: "HIGH" },
      { id: "CC5", title: "Control Activities", description: "Are control activities selected and developed that mitigate risks to the achievement of objectives?", risk: "HIGH" },
      { id: "CC6", title: "Logical and Physical Access Controls", description: "Is access to systems, data, and physical space appropriately restricted?", risk: "CRITICAL" },
      { id: "CC7", title: "System Operations", description: "Are system operations monitored and incidents responded to and recovered from?", risk: "HIGH" },
      { id: "CC8", title: "Change Management", description: "Are changes to systems authorized, designed, developed, configured, documented, tested, approved, and implemented?", risk: "HIGH" },
      { id: "CC9", title: "Risk Mitigation", description: "Does the entity manage risks associated with business partners and vendors?", risk: "MEDIUM" }
    ],
  },
  hipaa: {
    name: "HIPAA Security Rule",
    version: "Final Rule",
    description: "Health Insurance Portability and Accountability Act. Sets national standards to protect individuals' medical records and other personal health information.",
    items: [
      ...
      { id: "164.308(a)(3)", title: "Workforce Security", description: "Are policies implemented to ensure appropriate access to ePHI and prevent unauthorized access?", risk: "HIGH" },
      ...
      { id: "164.308(a)(6)", title: "Security Incident Procedures", description: "Are procedures implemented to address security incidents?", risk: "HIGH" },
      ...
      { id: "164.310(a)(1)", title: "Facility Access Controls", description: "Are physical access to electronic information systems and facilities restricted?", risk: "HIGH" },
      { id: "164.310(b)", title: "Workstation Use", description: "Are policies and procedures implemented that specify the proper functions to be performed on electronic computing devices?", risk: "MEDIUM" },
      { id: "164.312(a)(1)", title: "Access Control", description: "Are technical policies implemented to allow only authorized persons or software programs access to ePHI?", risk: "CRITICAL" },
      { id: "164.312(b)", title: "Audit Controls", description: "Are hardware, software, and procedural mechanisms implemented that record and examine activity in systems containing ePHI?", risk: "HIGH" },
  ...
  cisv8: {
    ...
    items: [
      { id: "CIS-1", title: "Inventory and Control of Enterprise Assets", description: "Are all enterprise assets accounted for and tracked?", risk: "HIGH" },
      { id: "CIS-2", title: "Inventory and Control of Software Assets", description: "Are all software assets accounted for and tracked?", risk: "HIGH" },
      { id: "CIS-3", title: "Data Protection", description: "Are processes and technical controls in place to protect data?", risk: "CRITICAL" },
      ...
      { id: "CIS-7", title: "Continuous Vulnerability Management", description: "Is a plan developed to continuously assess and track vulnerabilities?", risk: "HIGH" },
      { id: "CIS-8", title: "Audit Log Management", description: "Are audit logs collected, alerted on, reviewed, and retained?", risk: "MEDIUM" },
      { id: "CIS-9", title: "Email and Web Browser Protections", description: "Are protections implemented against threats from email and web vectors?", risk: "HIGH" },
      { id: "CIS-10", title: "Malware Defenses", description: "Are malicious software prevented, or controlled from executing on enterprise assets?", risk: "HIGH" },
      { id: "CIS-11", title: "Data Recovery", description: "Are data recovery practices sufficient to restore assets in-scope to a pre-incident and trusted state?", risk: "HIGH" },
      { id: "CIS-12", title: "Network Infrastructure Management", description: "Are network devices actively managed (tracked, reported, corrected) securely?", risk: "HIGH" },
      { id: "CIS-13", title: "Network Monitoring and Defense", description: "Is the network actively monitored and defended against threats?", risk: "HIGH" },
      ...
      { id: "CIS-18", title: "Penetration Testing", description: "Is the effectiveness of security controls tested?", risk: "MEDIUM" }
    ],
  },
  gdpr: {
    name: "GDPR",
    ...
    items: [
      ...
      { id: "Art-6", title: "Lawfulness of processing", description: "Is processing based on consent or another legitimate basis?", risk: "HIGH" },
      ...
      { id: "Art-15", title: "Right of access by the data subject", description: "Can data subjects obtain confirmation and access to their personal data?", risk: "MEDIUM" },
      { id: "Art-17", title: "Right to erasure ('right to be forgotten')", description: "Can data subjects have their personal data erased?", risk: "HIGH" },
      { id: "Art-25", title: "Data protection by design and by default", description: "Are appropriate technical and organisational measures implemented by design and by default?", risk: "HIGH" },
      { id: "Art-28", title: "Processor", description: "Are contracts in place with processors providing sufficient guarantees to implement appropriate technical and organisational measures?", risk: "HIGH" },
      ...
      { id: "Art-35", title: "Data protection impact assessment", description: "Is a DPIA carried out prior to processing that is likely to result in a high risk?", risk: "HIGH" },
      { id: "Art-37", title: "Designation of the data protection officer", description: "Is a DPO designated where required?", risk: "MEDIUM" },
      { id: "Art-44", title: "General principle for transfers", description: "Are personal data transfers to third countries or international organisations appropriately protected?", risk: "HIGH" }
    ],
  },
