export const FRAMEWORKS = {
    ...
    pcidss: {
        ...
        items: [
            ...
            { id: "Req 4", title: "Protect Cryptography During Transmission", description: "Is account data encrypted during transmission over open, public networks?", risk: "CRITICAL" },
            { id: "Req 5", title: "Protect All Systems and Networks from Malicious Software", description: "Is anti-malware deployed and actively updated?", risk: "HIGH" },
            { id: "Req 8", title: "Identify Users and Authenticate Access to System Components", description: "Is multi-factor authentication enforced for all administrative and remote access?", risk: "CRITICAL" },
        ],
    },
    soc2: {
        name: "SOC 2",
        version: "Type II",
        description: "Criteria for managing customer data based on security, availability, processing integrity, confidentiality, and privacy.",
        items: [
            ...
            { id: "CC5", title: "Logical and Physical Access Controls", description: "Are logical access security software, infrastructure, and architectures implemented to protect system components?", risk: "CRITICAL" },
            { id: "CC6", title: "System Operations", description: "Is the system monitored for anomalies indicative of malicious acts or natural disasters?", risk: "HIGH" },
            { id: "CC7", title: "Information and Communication", description: "Are relevant security events communicated to internal and external users?", risk: "MEDIUM" },
            { id: "CC8", title: "Risk Mitigation", description: "Does the entity perform vulnerability scans and risk assessments periodically?", risk: "HIGH" },
        ],
    },
    hipaa: {
        name: "HIPAA",
        ...
        items: [
            { id: "164.308(a)(1)", title: "Security Management Process", description: "Has a risk analysis been conducted and are risks managed to a reasonable and appropriate level?", risk: "HIGH" },
            { id: "164.308(a)(5)", title: "Security Awareness and Training", description: "Are all workforce members receiving security training?", risk: "MEDIUM" },
            ...
            { id: "164.312(b)", title: "Audit Controls", description: "Are hardware, software, and procedural mechanisms implemented that record and examine activity in info systems that contain ePHI?", risk: "HIGH" },
        ],
    },
    cisv8: {
        name: "CIS Controls",
        ...
        items: [
            { id: "IG1-1", title: "Inventory and Control of Enterprise Assets", description: "Is an accurate inventory of all enterprise assets maintained?", risk: "HIGH" },
            { id: "IG1-2", title: "Inventory and Control of Software Assets", description: "Is a software inventory maintained to ensure only authorized software is installed?", risk: "HIGH" },
            { id: "IG1-3", title: "Data Protection", description: "Are processes and technical controls established to identify, classify, and securely handle data?", risk: "CRITICAL" },
            ...
            { id: "IG1-5", title: "Account Management", description: "Are processes and tools used to assign and manage authorization to credentials?", risk: "CRITICAL" },
            { id: "IG1-6", title: "Access Control Management", description: "Is access to assets and software granted only to authorized users and processes?", risk: "CRITICAL" },
        ],
    },
};
