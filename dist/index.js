...
export const server = new McpServer({
    ...
    version: "1.0.0",
    description: "AI-powered security audit tools for multiple frameworks including OWASP, NIST, ISO 27001, and more",
});
...
server.tool("search_controls", "Search for security controls by keyword across all frameworks", {
    ...
    framework: z.enum([...frameworkKeys, "all"]).default("all"),
